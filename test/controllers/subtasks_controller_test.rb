...
class SubtasksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create subtask" do
    assert_difference('Subtask.count') do
      post subtasks_url, params: { subtask: { day: @subtask.day, name: @subtask.name, task_id: @subtask.task_id } }
    end
  ...
  test "should update subtask" do
    patch subtask_url(@subtask), params: { subtask: { day: @subtask.day, name: @subtask.name, task_id: @subtask.task_id } }
